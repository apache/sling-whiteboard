...
import org.apache.sling.jcr.wrappers.DefaultObjectWrapper;
...
public class LazyLoadingWrapper extends DefaultObjectWrapper {
    public Session wrap(RepositoryWrapper r, Session s) {
        // TODO take JackrabbitSessionWrapper into account
        return new LazyLoadingSession(r, s);
    }
    
    @Override
    public Node wrap(SessionWrapper s, Node n) {
        return new LazyLoadingNode(s, n);
    }
