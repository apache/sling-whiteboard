...
public class JackrabbitWorkspaceWrapper extends WorkspaceWrapper<JackrabbitWorkspace> implements JackrabbitWorkspace {
    public JackrabbitWorkspaceWrapper(SessionWrapper sessionWrapper, JackrabbitWorkspace delegate) {
    ...
    public PrivilegeManager getPrivilegeManager() throws RepositoryException {
        return new PrivilegeManagerWrapper(sessionWrapper, this.delegate.getPrivilegeManager());
    }
}
