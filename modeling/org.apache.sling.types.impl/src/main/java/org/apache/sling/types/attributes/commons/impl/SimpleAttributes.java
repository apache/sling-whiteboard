...
class SimpleAttributes<T extends AttributesProvider> implements WritableAttributes<T> {
    ...
    public SimpleAttributes(@NotNull Class<T> annotationSource) throws TypeException {
    ...
    private void defineAttributes(@NotNull Class<T> annotationSource) throws TypeException {
