...
public abstract class SimplePropertyHandler<T extends Property> implements PropertyHandler<T> {
    ...
    @Override
    @NotNull
    public Optional<?> getValue(@NotNull Context<Resource> ctx, @NotNull T property) throws TypeException {
    ...
    @Nullable
    protected abstract Object getValue(@NotNull T property, @NotNull ValueMap vm) throws TypeException;

    @Override
    public void setValue(@NotNull Context<Resource> ctx, @NotNull T property, RequestParameter... params) throws TypeException {
        String name = property.getName();
    ...
    protected abstract Object[] convertParams(@NotNull T property, RequestParameter... params) throws TypeException;
