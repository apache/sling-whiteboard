...
import org.apache.sling.modeling.attributes.Attributes;
import org.apache.sling.modeling.attributes.commons.AttributesFactory;
import org.apache.sling.modeling.data.commons.BooleanProperty;
...
class BooleanPropertyImpl extends SimpleProperty<BooleanProperty> implements BooleanProperty {
    ...
    public static class BooleanPropertyHandler extends SimplePropertyHandler<BooleanProperty> {
        ...
        @Override
        @Nullable
        protected Object getValue(@NotNull BooleanProperty property, @NotNull ValueMap vm) throws ModelException {
            ...
            throw new ModelException("Mismatched value: " + value);
        }
