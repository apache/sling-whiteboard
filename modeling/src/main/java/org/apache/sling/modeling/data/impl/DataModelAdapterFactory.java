 ...
 * under the License.
 */
package org.apache.sling.modeling.data.impl;
...
import org.apache.sling.modeling.data.DataModel;
import org.apache.sling.modeling.data.Property;
import org.apache.sling.modeling.data.spi.PropertyProvider;
...
@Component(
    property = {
        ...
        AdapterFactory.ADAPTER_CLASSES + "=org.apache.sling.modeling.data.DataModel"
    }
)
public class DataModelAdapterFactory implements AdapterFactory {
    ...
    public <AdapterType> AdapterType getAdapter(@NotNull Object adaptable, @NotNull Class<AdapterType> type) {
        ...
        return (AdapterType) new DataModel() {
            @Override
            @NotNull
