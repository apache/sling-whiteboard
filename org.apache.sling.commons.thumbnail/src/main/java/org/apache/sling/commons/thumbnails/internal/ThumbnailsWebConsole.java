 ...
 */
@Component(property = { Constants.SERVICE_DESCRIPTION + "=Web Console Plugin for Apache Sling Commons Thumbnails",
...
public class ThumbnailsWebConsole extends AbstractWebConsolePlugin {
    ...
    public static final String CONSOLE_LABEL = "commons-thumbnails";
    public static final String CONSOLE_TITLE = "Sling Commons Thumbnails";
