...
public class ExtensionOverrideRequestWrapper extends SlingHttpServletRequestWrapper {
    ...
    public ExtensionOverrideRequestWrapper(SlingHttpServletRequest wrappedRequest, String replacementExtension) {
        super(wrappedRequest);
        rpi = new ExtensionOverrideRequestPathInfo(wrappedRequest.getRequestPathInfo(), replacementExtension);
    }
